...
var AnotherPaymentComponent = (function () {
    function AnotherPaymentComponent(formBuilder, route, dropdownService, router, candidateService) {
    ...
    AnotherPaymentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.msgs = [];
        //this.displayAddCourseModel = false;
        ...
        this.candidateService.getCandidateDetailsByUserId(id).subscribe(function (data) {
            _this.registartionModel = data;
            console.log(_this.registartionModel);
            if (_this.registartionModel.candidateCourses.length > 0 && _this.registartionModel.candidateCourses.length != null) {
                console.log("Enter");
        ...
        this.paymentForm = this.formBuilder.group({
            ...
            'returnUrl': new forms_1.FormControl('http://192.168.0.79:3000/candidate/viewpaymentdetails'),
    ...
    AnotherPaymentComponent.prototype.paymentThroughPaypal = function () {
        var _this = this;
    ...
    AnotherPaymentComponent.prototype.addAnotherCourse = function () {
        this.displayAddCourseModel = true;
    };
    AnotherPaymentComponent.prototype.addCourses = function () {
        var _this = this;
        this.candidateSelectedCourse = new candidate_selcted_course_model_1.CandidateSelectedCourse();
        this.candidateSelectedCourse.candidateFinalCourses = new Array();
        ...
        this.candidateService.updateCourse(this.candidateSelectedCourse).subscribe(function (data) {
            ...
            if (_this.candidate.candidateCourses.length > 0 && _this.candidate.candidateCourses != null) {
    ...
    return AnotherPaymentComponent;
}());
AnotherPaymentComponent = __decorate([
    core_1.Component({
...
exports.AnotherPaymentComponent = AnotherPaymentComponent;
//# sourceMappingURL=candidate.another.payment.component.js.map